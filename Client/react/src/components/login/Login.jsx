  ...
  return (
    <div className='form_container'>
      <form onSubmit={handleSubmit(onsubmit)} className='form'>
        ...
        <label htmlFor="coutry">Select Country :</label>
        <select id="country" className='country_select'>
        ...
        {errors.country && <p>{errors.name.message}</p> }

        <label htmlFor="age">Age :</label>
        <input type="number" id='age' placeholder='Enter your age'/>

        <label htmlFor="content">URL :</label>
        <input type="url" id="content" placeholder='Enter the content URL'/>
